...
def lvm_thpool_convert(vg_name, data_lv, metadata_lv, name=None):
    return _lvm_thpool_convert(vg_name, data_lv, metadata_lv, name)
...
def lvm_cache_pool_convert(vg_name, data_lv, metadata_lv, name=None):
    return _lvm_cache_pool_convert(vg_name, data_lv, metadata_lv, name)
