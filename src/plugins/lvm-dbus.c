...
gboolean bd_lvm_thpool_convert (gchar *vg_name, gchar *data_lv, gchar *metadata_lv, gchar *name, GError **error) {
    ...
    call_lvm_obj_method_sync (vg_name, VG_INTF, "CreateThinPool", params, NULL, error);

    if (((*error) == NULL) && name)
        bd_lvm_lvrename (vg_name, data_lv, name, error);
    return ((*error) == NULL);
}
...
gboolean bd_lvm_cache_pool_convert (gchar *vg_name, gchar *data_lv, gchar *metadata_lv, gchar *name, GError **error) {
    ...
    call_lvm_obj_method_sync (vg_name, VG_INTF, "CreateCachePool", params, NULL, error);
