...
gboolean _crypto_luks_format (const gchar *device, const gchar *cipher, guint64 key_size, BDCryptoKeyslotContext *context, guint64 min_entropy,
                              BDCryptoLUKSVersion luks_version, BDCryptoLUKSExtra *extra, BDCryptoLUKSHWEncryptionType hw_encryption,
                              BDCryptoKeyslotContext *opal_context, GError **error) {
#else
gboolean _crypto_luks_format (const gchar *device, const gchar *cipher, guint64 key_size, BDCryptoKeyslotContext *context, guint64 min_entropy,
                              BDCryptoLUKSVersion luks_version, BDCryptoLUKSExtra *extra, BDCryptoLUKSHWEncryptionType hw_encryption,
                              BDCryptoKeyslotContext *opal_context G_GNUC_UNUSED, GError **error) {
#endif
    struct crypt_device *cd = NULL;
    gint ret;
