...
class LvmTestThpool(LvmPVVGthpoolTestCase):
    ...
    def test_thpoolcreate(self):
        ...
        self.assertEqual(info.segtype, "thin-pool")
        self.assertTrue(info.data_lv)
        self.assertIn("_tdata", info.data_lv)
        self.assertTrue(info.metadata_lv)
        self.assertIn("_tmeta", info.metadata_lv)
        self.assertEqual(info.origin, None)
        self.assertEqual(info.pool_lv, None)
...
class LvmTestThLV(LvmPVVGLVthLVTestCase):
    ...
    def test_thlvcreate_thpoolname(self):
        ...
        self.assertEqual(info.segtype, "thin")
        self.assertEqual(info.origin, None)
    ...
    def test_thsnapshotcreate(self):
        ...
        self.assertEqual(info.segtype, "thin")
        self.assertEqual(info.origin, "testThLV")
        self.assertEqual(info.pool_lv, "testPool")
