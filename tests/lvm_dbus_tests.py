...
class LvmNoDevTestCase(unittest.TestCase):
    ...
    def test_get_set_global_config(self):
        ...
        BlockDev.lvm_pvscan(None, False)
...
class LvmTestThpoolConvert(LvmPVVGthpoolTestCase):
    def test_thpool_convert(self):
        ...
        succ = BlockDev.lvm_lvcreate("testVG", "dataLV", 512 * 1024**2, None, [self.loop_dev])
        self.assertTrue(succ)
        succ = BlockDev.lvm_lvcreate("testVG", "metadataLV", 50 * 1024**2, None, [self.loop_dev2])
        self.assertTrue(succ)

        succ = BlockDev.lvm_thpool_convert("testVG", "dataLV", "metadataLV", "testPool")
        self.assertTrue(succ)
...
class LvmTestCachePoolConvert(LvmPVVGLVcachePoolTestCase):
    def test_cache_pool_convert(self):
        ...
        succ = BlockDev.lvm_cache_pool_convert("testVG", "dataLV", "metadataLV", "testCache")
        self.assertTrue(succ)
